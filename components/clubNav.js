    ...
    return (
        <>
            ...
            {/* <View style={styles.buttonsAllTimeCont}>
                <Pressable onPress={() => n.navigate('Surveys')} style={styles.buttonOfNav}>
                ...
                {sett &&
                    <Pressable onPress={() => n.navigate('ClubSettings')} style={styles.buttonOfNav}>
